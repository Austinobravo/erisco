...
const AboutHero = () => {
  return (
    <section className='text-center py-28 space-y-5 px-10'>
        <h1 className='font-bold text-sm opacity-60'>About Us</h1>
        <h2 className='text-5xl font-bold md:px-20 px-0 leading-snug'>Taste the Richness when locality meets quality on your taste buds.</h2>
